...
describe('events', () => {
  ...
  scenario('creates a event', async () => {
    const result = await createEvent({
      input: {
        name: 'String',
        date: '2023-12-06T20:41:15.820Z',
        updatedAt: '2023-12-06T20:41:15.820Z',
      },
    })

    expect(result.name).toEqual('String')
    expect(result.date).toEqual(new Date('2023-12-06T20:41:15.820Z'))
    expect(result.updatedAt).toEqual(new Date('2023-12-06T20:41:15.820Z'))
  })
